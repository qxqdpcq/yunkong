...
window.YKimport(function(lib,game,ui,get,ai,_status){
	...
	window.ykChallenge_funcsList={
		...
		chooseAct:function(){
			...
			if(this.owner==game.me){
				...
				help.onclick=function(){
					...
					window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/alert.png',introduce,true,'100% 100%');
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/help.png',help,true,'cover');
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/chooseButton1.png',move,true,'cover');
				move.character=this;
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/chooseButton1.png',useSkill,true,'cover');
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/chooseButton1.png',attack,true,'cover');
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/chooseButton1.png',act,true,'cover');
				act.character=this;
					...
					if(action.top){
						var othersx={
							...
							func:function(character){
								...
								var urlObj=['https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/character/'+character.name+'/standby/',4,'.png'];
						...
						var urlObj=['https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/character/'+character.name+'/move/',4,'.png'];
						window.showPlayerAnimation(character,urlObj,othersx);
		...
		attack:function(triggered){
			...
			var urlObj=['https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/character/'+this.name+'/attack/',6,'.png'];
		...
		chooseSkill:function(){
			...
			if(this.skills) for(var skill in this.skills) if(this.skills[skill]&&this.skills[skill].enable=='phaseUse'){
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/showSkillInfo.png',div,true,'100% 100%');
				div.skill=skill;
				div.character=this;
			...
			if(event.player&&event.player!=this){
				...
				if(this.hujia<=0){
					...
					if(this.hujiaDiv){
						...
						window.showPictAnimation('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/loseHujia/',10,'.png',this.loseHujiaDiv,othersx);
					...
					window.showPictAnimation('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/gainHujia/',5,'.png',this.gainHujiaDiv,othersx);
					...
					window.showPictAnimation('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/hujiaDiv/',65,'.png',this.hujiaDiv,othersx);
				}
			}
		...
		loseDefendAnimation:function(){
			...
			window.showPictAnimation('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/loseDefend/',10,'.png',this.defendDeBuffAnimation,othersx);
		},
		recoverAnimation:function(){
			...
			window.showPictAnimation('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/recover/',11,'.png',this.recoverAnimationDiv,othersx);
		},
	};
	...
	window.ykChallenge_getInfo=function(character){
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/characterInfo.png',_status.ykChallenge_showInfo,true,'100% 100%');
	...
	window.yk_enemyChooseCharacter=function(){
		...
		for(var name of characterList){
			...
			window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/characterImg/'+name+'.jpg',window.yk_enemyCharacterPhaseImg[name],true,'cover');
		}
		...
		for(var i=0;i<characterList.length;i++){
			...
			window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/openInfo.png',character.openInfo,true,'100% 100%');
			...
			var urlObj=['https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/shouUpTime/',22,'.png'];
			window.showPlayerAnimation(character,urlObj,othersx);
		}
	...
	window.ykChallenge_start=function(characterList){
		...
		setTimeout(function(){
			if(window.yk_characterPhaseImg[next_character.name]){
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/characterImg/'+next_character.name+'.jpg',window.yk_characterPhaseImg[next_character.name],true,'cover');
			}
		},2100);
	...
	game.ykmodeStart=function(){
		...
		for(var url in ykChallengeUrlList){
			...
			if(!num){
				imgUrl='https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/'+url+'.png';
				if(lib.config.ykImageCache[imgUrl]&&lib.config.ykImageCache[imgUrl+'_src']) continue;
				imgUrlList.push(imgUrl);
			}
			else{
				for(var i=0;i<num;i++){
					imgUrl='https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/'+url+num+'.png';
					if(lib.config.ykImageCache[imgUrl]&&lib.config.ykImageCache[imgUrl+'_src']) continue;
					imgUrlList.push(imgUrl);
				}
			}
	...
	window.ykChallengeGamepreStart=function(characterList){
		...
		for(var name of characterList){
			...
			window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/ykChallengesucai/git/raw/master/characterImg/'+name+'.jpg',window.yk_characterPhaseImg[name],true,'cover');
		}
