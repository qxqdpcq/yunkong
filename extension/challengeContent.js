...
window.YKimport(function(lib,game,ui,get,ai,_status){
	...
	window.ykChallenge_funcsList={
		...
		chooseAct:function(){
			...
			if(this.owner==game.me){
				...
				help.onclick=function(){
					...
					window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/alert.png',introduce,true,'100% 100%');
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/help.png',help,true,'cover');
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/chooseButton1.png',move,true,'cover');
				move.character=this;
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/chooseButton1.png',useSkill,true,'cover');
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/chooseButton1.png',attack,true,'cover');
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/chooseButton1.png',act,true,'cover');
				act.character=this;
					...
					if(action.top){
						var othersx={
							...
							func:function(character){
								...
								var urlObj=['https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/character/'+character.name+'/standby/',4,'.png'];
						...
						var urlObj=['https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/character/'+character.name+'/move/',4,'.png'];
						window.showPlayerAnimation(character,urlObj,othersx);
		...
		attack:function(triggered){
			...
			var urlObj=['https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/character/'+this.name+'/attack/',6,'.png'];
		...
		chooseSkill:function(){
			...
			if(this.skills) for(var skill in this.skills) if(this.skills[skill]&&this.skills[skill].enable=='phaseUse'){
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/showSkillInfo.png',div,true,'100% 100%');
				div.skill=skill;
				div.character=this;
			...
			if(event.player&&event.player!=this){
				...
				if(this.hujia<=0){
					...
					if(this.hujiaDiv){
						...
						window.showPictAnimation('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/loseHujia/',10,'.png',this.loseHujiaDiv,othersx);
					...
					window.showPictAnimation('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/gainHujia/',5,'.png',this.gainHujiaDiv,othersx);
					...
					window.showPictAnimation('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/hujiaDiv/',65,'.png',this.hujiaDiv,othersx);
				}
			}
		...
		loseDefendAnimation:function(){
			...
			window.showPictAnimation('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/loseDefend/',10,'.png',this.defendDeBuffAnimation,othersx);
		},
		recoverAnimation:function(){
			...
			window.showPictAnimation('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/recover/',11,'.png',this.recoverAnimationDiv,othersx);
		},
	};
	...
	window.ykChallenge_getInfo=function(character){
		...
		window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/characterInfo.png',_status.ykChallenge_showInfo,true,'100% 100%');
	...
	window.yk_enemyChooseCharacter=function(){
		...
		for(var name of characterList){
			...
			window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/characterImg/'+name+'.jpg',window.yk_enemyCharacterPhaseImg[name],true,'cover');
		}
		...
		for(var i=0;i<characterList.length;i++){
			...
			window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/openInfo.png',character.openInfo,true,'100% 100%');
			...
			var urlObj=['https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/showUpTime/',22,'.png'];
			window.showPlayerAnimation(character,urlObj,othersx);
		}
	...
	window.ykChallenge_start=function(characterList){
		...
		setTimeout(function(){
			if(window.yk_characterPhaseImg[next_character.name]){
				...
				window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/characterImg/'+next_character.name+'.jpg',window.yk_characterPhaseImg[next_character.name],true,'cover');
			}
		},2100);
	...
	game.ykmodeStart=function(){
		...
		for(var url in ykChallengeUrlList){
			...
			if(!num){
				imgUrl='https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/'+url+'.png';
				if(lib.config.ykImageCache[imgUrl]&&lib.config.ykImageCache[imgUrl+'_src']) continue;
				imgUrlList.push(imgUrl);
			}
			else{
				for(var i=0;i<num;i++){
					imgUrl='https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/'+url+num+'.png';
					if(lib.config.ykImageCache[imgUrl]&&lib.config.ykImageCache[imgUrl+'_src']) continue;
					imgUrlList.push(imgUrl);
				}
			}
	...
	window.ykChallengeGamepreStart=function(characterList){
		...
		for(var name of characterList){
			...
			window.ykCacheSetImage('https://gitee.com/qxqdpcq/yunkong/raw/master/ykChallengesucai/characterImg/'+name+'.jpg',window.yk_characterPhaseImg[name],true,'cover');
		}
