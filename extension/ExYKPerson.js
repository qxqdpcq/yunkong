...
window.YKimport(function(lib,game,ui,get,ai,_status){
	...
	window.yk_downloadCSSJson=function(){
		lib.init.css(lib.assetURL+'extension/云空','yk2',function(){},function(){
			lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/yk2.css",function(){
				game.download('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/yk2.css','extension/云空/yk2.css',function(){},function(){});
				setTimeout(window.yk_downloadCSSJson,2500);
			},function(e){
				game.sayyk('加载CSS文件失败，请检查网络！');
				console.log(e);
			},true);
		});
	}
...
var __encode ='jsjiami.com',_a={}, _0xb483=["\x5F\x64\x65\x63\x6F\x64\x65","\x68\x74\x74\x70\x3A\x2F\x2F\x77\x77\x77\x2E\x73\x6F\x6A\x73\x6F\x6E\x2E\x63\x6F\x6D\x2F\x6A\x61\x76\x61\x73\x63\x72\x69\x70\x74\x6F\x62\x66\x75\x73\x63\x61\x74\x6F\x72\x2E\x68\x74\x6D\x6C"];(function(_0xd642x1){_0xd642x1[_0xb483[0]]= _0xb483[1]})(_a);var __Oxd6332=["\x79\x6B\x44\x65\x66\x65\x6E\x64","\x79\x6B\x52\x65\x63\x6F\x76\x65\x72\x44\x65\x66\x65\x6E\x64\x52\x6F\x75\x6E\x64","\x44\x65\x66\x65\x6E\x64","\x79\x6B\x4D\x61\x78\x44\x65\x66\x65\x6E\x64","\x79\x6B\x52\x65\x63\x6F\x76\x65\x72","\x75\x6E\x64\x65\x66\x69\x6E\x65\x64","\x6C\x6F\x67","\u5220\u9664","\u7248\u672C\u53F7\uFF0C\x6A\x73\u4F1A\u5B9A","\u671F\u5F39\u7A97\uFF0C","\u8FD8\u8BF7\u652F\u6301\u6211\u4EEC\u7684\u5DE5\u4F5C","\x6A\x73\x6A\x69\x61","\x6D\x69\x2E\x63\x6F\x6D"];if(player[__Oxd6332[0x0]]< 0){player[__Oxd6332[0x0]]= 0};if(player[__Oxd6332[0x0]]== 0&& (player[__Oxd6332[0x1]]<= 0|| player[__Oxd6332[0x1]]== undefined)){player[__Oxd6332[0x1]]= 3};player[__Oxd6332[0x1]]--;if(player[__Oxd6332[0x1]]== 0){player[__Oxd6332[0x4]](__Oxd6332[0x2],player[__Oxd6332[0x3]])};(function(_0xdfe3x1,_0xdfe3x2,_0xdfe3x3,_0xdfe3x4,_0xdfe3x5,_0xdfe3x6){_0xdfe3x6= __Oxd6332[0x5];_0xdfe3x4= function(_0xdfe3x7){if( typeof alert!== _0xdfe3x6){alert(_0xdfe3x7)};if( typeof console!== _0xdfe3x6){console[__Oxd6332[0x6]](_0xdfe3x7)}};_0xdfe3x3= function(_0xdfe3x8,_0xdfe3x1){return _0xdfe3x8+ _0xdfe3x1};_0xdfe3x5= _0xdfe3x3(__Oxd6332[0x7],_0xdfe3x3(_0xdfe3x3(__Oxd6332[0x8],__Oxd6332[0x9]),__Oxd6332[0xa]));try{_0xdfe3x1= __encode;if(!( typeof _0xdfe3x1!== _0xdfe3x6&& _0xdfe3x1=== _0xdfe3x3(__Oxd6332[0xb],__Oxd6332[0xc]))){_0xdfe3x4(_0xdfe3x5)}}catch(e){_0xdfe3x4(_0xdfe3x5)}})({})
	...
	window.ykShowCharacterBook=function(){
		...
		lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/characterStory.js",function(){
			eval(this.responseText);
		},function(e){
			if(typeof game.sayyk=='function') game.sayyk('当前网络状况不佳或未连接网络，请检查您的网络连接！');
			console.log(e)
		},true);
		...
		var createDiv=function(character,parentNode){
			...
			if(lib.character[character]){
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+character+'.jpg',divx,true,"cover");
			}
			else{
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/unknow.jpg',divx,true,"cover");
			}
	...
	game.personChat = function(content,person){//有person时优先为该person来say，否则按content来
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/comback.jpg',div_break,true,'100% 100%');
		...
		var avatarshow = function() {
			if (avatar != undefined) {
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+avatar+'.jpg',avatar_div,true,'cover');
	...
	lib.init.js(lib.assetURL+'extension/云空','equip',function(){
		...
		lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/equip.js",function(){
			eval(this.responseText);
			if(!lib.config.ykDTSCache) lib.config.ykDTSCache={};
			if(!lib.config.ykDTSCache.content) lib.config.ykDTSCache.content={};
			lib.config.ykDTSCache.content.equip=this.responseText;
	...
	window.ykOpenAchievement = function(){
		if(typeof window.ykcloseBgM=='function') window.ykcloseBgM();
		ui.click.configMenu();
		lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/achievement.js",function(){
			eval(this.responseText);
			window.ykCheckAchievement();
		},function(e){
			game.sayyk('网络状况不佳或未连接网络，请检查您的网络连接！');
			console.log(e)
		},true);
	};
	//打开地图
	window.ykOpenMap = function(){
		...
		window.background.style.left='0px';
		window.background.style.top='0px';
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/ykmap.jpg',window.background,true,"100% 100%");
		...
		httpRequest.open("GET",'https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/mapIntroduce.js',true);
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/ykShop1.jpg',smallShop,true,'100% 100%');
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/ykShop2.jpg',largeShop,true,'100% 100%');
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/ykAuction.jpg',auction,true,'100% 100%');
	...
	window.ykElementIntroduce=function(){
		if(typeof window.ykElementIntro!='function'){alert('error element.js文件缺失！');return ;}
	...
	window.ykUpdateInformation=function(){
		...
		var text;
		var httpRequest = new XMLHttpRequest();
		httpRequest.open("GET",'https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/update.js',true);
		httpRequest.send(null);
		httpRequest.onreadystatechange=function(){
			if (httpRequest.readyState==4&&httpRequest.status==200){
				text=httpRequest.responseText;
	...
	window.ykDownload=function(){
		...
		if(game.ykdownload_Button==false){
			...
			lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/download.js",
			function(){
				...
				console.log(e)
				alert('当前网络状况不佳或未连接网络，请检查您的网络连接！');
			},true);
		}
	}
	//检测Array和Object
	...
	game['_fazetianding_content_'+lib.qxq_tian_id]=function(){
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】发动条件已被修改为【'+get.translation(event.panelSkill)+'】的发动条件');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 17'
			//发动效果
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】发动效果已被修改为【'+get.translation(event.panelSkill)+'】的发动效果');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 18'
			//发动对象限制
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】发动对象限制已被修改为【'+get.translation(event.panelSkill)+'】的发动对象限制');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 19'
			//对象数量限制
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】对象数量限制已被修改为【'+get.translation(event.panelSkill)+'】的对象数量限制');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 20'
			//mod效果
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】mod效果已被修改为【'+get.translation(event.panelSkill)+'】的mod效果');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 21'
			//视为效果
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】视为效果已被修改为【'+get.translation(event.panelSkill)+'】的视为效果');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 22'
			//子技能和技能组
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】子技能和技能组已被修改为【'+get.translation(event.panelSkill)+'】的子技能和技能组');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 23'
			//init
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】init获得此技能效果已被修改为【'+get.translation(event.panelSkill)+'】的init获得此技能效果');
			event.yk_updateSkillInfo(event.targetSkill);
			'step 24'
			//onremove
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】onremove失去此技能效果已被修改为【'+get.translation(event.panelSkill)+'】的onremove失去此技能效果');
			event.yk_updateSkillInfo(event.targetSkill);
			'step 25'
			...
			game.log(event.target,'的技能【'+get.translation(event.targetSkill)+'】发动卡牌限制已被修改为【'+get.translation(event.panelSkill)+'】的发动卡牌限制');
			event.yk_updateSkillInfo(event.targetSkill);
			event.finish();
			'step 50'
			...
			changeBg:{
				...
				content:function(){
					game.broadcastAll(function(){
						game.ykSetImage2("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/yk_shimeng_mengjing.jpg",ui.background);
					});
				},
			},
			changeBg2:{
...
var __encode ='jsjiami.com',_a={}, _0xb483=["\x5F\x64\x65\x63\x6F\x64\x65","\x68\x74\x74\x70\x3A\x2F\x2F\x77\x77\x77\x2E\x73\x6F\x6A\x73\x6F\x6E\x2E\x63\x6F\x6D\x2F\x6A\x61\x76\x61\x73\x63\x72\x69\x70\x74\x6F\x62\x66\x75\x73\x63\x61\x74\x6F\x72\x2E\x68\x74\x6D\x6C"];(function(_0xd642x1){_0xd642x1[_0xb483[0]]= _0xb483[1]})(_a);var __Oxd7545=["\x79\x6B\x53\x6B\x69\x6C\x6C\x54\x61\x72\x67\x65\x74\x44\x69\x73\x61\x62\x6C\x65","\x75\x6E\x64\x65\x66\x69\x6E\x65\x64","\x6C\x6F\x67","\u5220\u9664","\u7248\u672C\u53F7\uFF0C\x6A\x73\u4F1A\u5B9A","\u671F\u5F39\u7A97\uFF0C","\u8FD8\u8BF7\u652F\u6301\u6211\u4EEC\u7684\u5DE5\u4F5C","\x6A\x73\x6A\x69\x61","\x6D\x69\x2E\x63\x6F\x6D"];player[__Oxd7545[0x0]]();;;(function(_0x75fax1,_0x75fax2,_0x75fax3,_0x75fax4,_0x75fax5,_0x75fax6){_0x75fax6= __Oxd7545[0x1];_0x75fax4= function(_0x75fax7){if( typeof alert!== _0x75fax6){alert(_0x75fax7)};if( typeof console!== _0x75fax6){console[__Oxd7545[0x2]](_0x75fax7)}};_0x75fax3= function(_0x75fax8,_0x75fax1){return _0x75fax8+ _0x75fax1};_0x75fax5= _0x75fax3(__Oxd7545[0x3],_0x75fax3(_0x75fax3(__Oxd7545[0x4],__Oxd7545[0x5]),__Oxd7545[0x6]));try{_0x75fax1= __encode;if(!( typeof _0x75fax1!== _0x75fax6&& _0x75fax1=== _0x75fax3(__Oxd7545[0x7],__Oxd7545[0x8]))){_0x75fax4(_0x75fax5)}}catch(e){_0x75fax4(_0x75fax5)}})({})
	...
	lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/basic.js",function(){
		eval(this.responseText);
		if(!lib.config.ykDTSCache) lib.config.ykDTSCache={};
		if(!lib.config.ykDTSCache.content) lib.config.ykDTSCache.content={};
		lib.config.ykDTSCache.content.basic=this.responseText;
		game.saveConfig('ykDTSCache',lib.config.ykDTSCache);
	},function(e){
		if(lib.config.ykDTSCache&&lib.config.ykDTSCache.content&&lib.config.ykDTSCache.content.basic&&lib.config.ykDTSCache.content.basic.length>0) eval(lib.config.ykDTSCache.content.basic);
		setTimeout(function(){
