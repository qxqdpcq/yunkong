...
window.YKimport(function(lib,game,ui,get,ai,_status){
	...
	window.ykCheckAchievement=function(){
		...
		if(lib.device!='android'&&lib.device!='ios'){
			window.backgroundA.setBackgroundImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/twinkleStar.jpg');
		}
		else{
			window.backgroundA.style.backgroundImage="url('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/twinkleStar.jpg')";
		}
