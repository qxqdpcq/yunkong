	...
	httpRequest.onreadystatechange= () =>{
		if (httpRequest.readyState==4&&httpRequest.status==200){
			if(lib.config.ykDTSCache.content.version!=httpRequest.responseText){
				...
				for(var js of loadList) window.ykloadjs(js);
			}
		}
	};
	lib.yk_personInfo={
...
// ---------------------------------------适配千幻用------------------------------------------//
	...
	lib.ykDrawCardPoolSchel={
		...
		qxq_yk_xiaoqiao:[[2022,10,4],[2022,10,22],'<span style=\"color: #00FFFF;\">浮世</span><small><u>飘零</u></small>',['qxq_yk_fuling'],[],[]],
		qxq_yk_yanmengyuejian:[[2022,10,23],[2022,11,11],'<span style=\"color: #00FFFF;\">梦与</span><small><u>君同</u></small>',['qxq_yk_fuling'],[],[]],
	};
