...
window.YKimport(function(lib,game,ui,get,ai,_status){
	...
	lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/achievement.js",function(){
		setTimeout(function(){
			if(game.saydpcq&&typeof game.saydpcq=='function') game.saydpcq('成就解锁系统正常，请放心游玩！');
		},2000);
		eval(this.responseText);
	},function(e){
		setTimeout(function(){
			if(game.saydpcq&&typeof game.saydpcq=='function') game.saydpcq('网络状况不佳或未连接网络，可能导致扩展成就无法解锁！请检查您的网络连接！');
		},2000);
		console.log(e)
	},true);
	var ykdateUpdate=function(){
		...
		if(lib.config.yk_updateDate==undefined||lib.config.yk_updateDate!=day){
			...
			game.download('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/challenge.js','extension/云空/challenge.js',function(){},function(){});
			game.download('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/element.js','extension/云空/element.js',function(){},function(){});
			game.download('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/skin.js','extension/云空/skin.js',function(){},function(){});
	...
	window.yk_downloadElementJson=function(){
		lib.init.js(lib.assetURL+'extension/云空','element',function(){},function(){
			lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/element.js",function(){
				game.download('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/element.js','extension/云空/element.js',function(){},function(){});
				setTimeout(window.yk_downloadElementJson,2500);
			},function(e){
				game.sayyk('加载element.js文件失败，请检查网络！');
				console.log(e);
			},true);
		});
	}
...
// ---------------------------------------适配千幻用------------------------------------------//
	window.yk_downloadSkinJson=function(){
		lib.init.js(lib.assetURL+'extension/云空','skin',function(){},function(){
			lib.init.req("https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/skin.js",function(){
				game.download('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/skin.js','extension/云空/skin.js',function(){},function(){});
				setTimeout(window.yk_downloadSkinJson,2500);
			},function(e){
				game.sayyk('加载skin.js文件失败，请检查网络！');
				console.log(e);
			},true);
		});
	}
	...
	window.yk_unlockScreen=function(type,name,func,funcContent){
		...
		if(type=='character'){
			...
			window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+name+'.jpg',window.animationBackgroundCharacter,true,"cover");
