...
// ---------------------------------------适配千幻用------------------------------------------//
	...
	if(lib.arenaReady) lib.arenaReady.push(function(){
		...
		ui.ykSpecialCode.onclick=function(){
			var face=ui.create.div('.menu');
			face.cssText='height:100px,width:150px;left:calc(100% - 75px);top:calc(100% - 50px);z-index:9999;border-radius:8px;';
			face.add('兑换码');
	...
	lib.ykDrawCardPoolSchel={
		...
		qxq_yk_mingyun:[[2022,10,4],[2022,10,22],'<span style=\"color: #00FFFF;\">云端</span><small><u>遥想</u></small>',['qxq_yk_fuling'],[],[]],
		qxq_yk_wuwangxuanyue:[[2022,9,18],[2022,10,3],'<span style=\"color: #FF0000;\">千古</span><small><u>一念</u></small>',['qxq_yk_fuling'],[],[]],
		qxq_yk_xiaoqiao:[[2022,10,23],[2022,11,11],'<span style=\"color: #00FFFF;\">浮世</span><small><u>飘零</u></small>',['qxq_yk_fuling'],[],[]],
		qxq_yk_yanmengyuejian:[[2022,11,12],[2022,11,30],'<span style=\"color: #00FFFF;\">梦与</span><small><u>君同</u></small>',['qxq_yk_fuling'],[],[]],
	};
