...
window.YKimport(function(lib,game,ui,get,ai,_status){
	...
	window.ykEquip = function(){
				...
				for(var x=0;x<name.length;x++){
					if(this.innerHTML=='<span style="cursor:pointer;color:#FFFFFF;">'+get.translation(name[x])+'</span>'){
						...
						if(lib.config[name[x]+'_equip1']){
							if(lib.ykEquip&&lib.ykEquip[lib.config[name[x]+'_equip1']]&&lib.ykEquip[lib.config[name[x]+'_equip1']].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykEquip[lib.config[name[x]+'_equip1']].image,game.yk_characterEquip1,true,"cover");
							else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.config[name[x]+'_equip1']+'.jpg',game.yk_characterEquip1,true,"cover");
						}
						...
						if(lib.config[name[x]+'_equip2']){
							if(lib.ykEquip&&lib.ykEquip[lib.config[name[x]+'_equip2']]&&lib.ykEquip[lib.config[name[x]+'_equip2']].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykEquip[lib.config[name[x]+'_equip2']].image,game.yk_characterEquip2,true,"cover");
							else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.config[name[x]+'_equip2']+'.jpg',game.yk_characterEquip2,true,"cover");
						}
						...
						if(lib.config[name[x]+'_equip3']){
							if(lib.ykEquip&&lib.ykEquip[lib.config[name[x]+'_equip3']]&&lib.ykEquip[lib.config[name[x]+'_equip3']].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykEquip[lib.config[name[x]+'_equip3']].image,game.yk_characterEquip3,true,"cover");
							else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.config[name[x]+'_equip3']+'.jpg',game.yk_characterEquip3,true,"cover");
						}
						...
						if(lib.config[name[x]+'_equip4']){
							if(lib.ykEquip&&lib.ykEquip[lib.config[name[x]+'_equip4']]&&lib.ykEquip[lib.config[name[x]+'_equip4']].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykEquip[lib.config[name[x]+'_equip4']].image,game.yk_characterEquip4,true,"cover");
							else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.config[name[x]+'_equip4']+'.jpg',game.yk_characterEquip4,true,"cover");
						}
						...
						if(lib.config[name[x]+'_book']){
							if(lib.ykEquip&&lib.ykBook[lib.config[name[x]+'_book']]&&lib.ykBook[lib.config[name[x]+'_book']].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykBook[lib.config[name[x]+'_book']].image,game.yk_characterBook,true,"cover");
							else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.config[name[x]+'_book']+'.jpg',game.yk_characterBook,true,"cover");
						}
		...
		for(var i of list){
			if((lib.yk_otherItemLibrary[i]||lib.ykEquip[i]||lib.ykBook[i])&&lib.config.yk_myBag[i].isUsing!=true){
				...
				if(lib.ykEquip&&lib.ykEquip[i]&&lib.ykEquip[i].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykEquip[i].image,divx,true,"100% 100%");
				else if(lib.ykBook&&lib.ykBook[i]&&lib.ykBook[i].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykBook[i].image,divx,true,"100% 100%");
				else if(lib.yk_otherItemLibrary&&lib.yk_otherItemLibrary[i]&&lib.yk_otherItemLibrary[i].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.yk_otherItemLibrary[i].image,divx,true,"100% 100%");
				else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+i+'.jpg',divx,true,"100% 100%");
				...
				if(rank){
					...
					window.showPictAnimation('https://jfc1999.coding.net/p/dpcqxyys/d/ykBackground/git/raw/master/ykSucai/'+rank+'/',10,'.png',divx,othersx);
				}
			}
		}
	};
	...
	window.ykupgradeBE=function(name){
		...
		if(lib.ykEquip[name]&&lib.ykEquip[name].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykEquip[name].image,window.ykEquipImg,true,"100% 100%");
		else if(lib.ykBook[name]&&lib.ykBook[name].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.ykBook[name].image,window.ykEquipImg,true,"100% 100%");
		else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+name+'.jpg',window.ykEquipImg,true,"100% 100%");
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+((grade=='godgrade'||grade=='half-godgrade')?'tiangrade':grade)+'.jpg',window.ykEquipImgG,true,"100% 100%");
		...
		if(lib.ykEquip[name]){
			...
			if(lib.ykEquip[name]&&lib.config.yk_myBag[name].rank1<10){
				...
				for(var item in lib.ykEquip[name].strength) if(item!='rate'&&lib.ykEquip[name].strength[item][''+lib.config.yk_myBag[name].rank1]){
					...
					window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+(lib.yk_otherItemLibrary[item].image||(item+'.jpg')),div,lib.yk_otherItemLibrary[item],"100% 100%");
			...
			if(lib.ykBook[name]&&lib.config.yk_myBag[name].rank2<10){
				...
				window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+(lib.yk_otherItemLibrary[itemx].image||(itemx+'.jpg')),div,lib.yk_otherItemLibrary[itemx],"100% 100%");
	...
	window.ykOpenShop=function(scale){//商店
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/yk'+scale+'Shop.jpg',window.ykShop1,true,"100% 100%");
		...
		var content=[{
			...
			avatar:'none',
			background:'https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/yk'+scale+'Shop.jpg',
		}];
		...
		for(var item of itemList){
			...
			if(lib.yk_otherItemLibrary&&lib.yk_otherItemLibrary[item]&&lib.yk_otherItemLibrary[item].image) window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+lib.yk_otherItemLibrary[item].image,divx,true,"100% 100%");
			else window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+item+'.jpg',divx,true,"100% 100%");
			divx.name=item;
			divx.scale=scale;
	...
	window.ykOpenAuction=function(){//拍卖会（上半场和下半场）
		...
		if(window.ykCheckAuctionOpen()=='deley'){
			...
			if(list){
				...
				for(var n=0;n<list.length;n++){
					...
					window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+list[n].image,divm,true,'100% 100%');
					...
					var ok=ui.create.div('','<font color=black>竞拍</font>',function(){
						...
						window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+this.image,img,true,'100% 100%');
						window.ykofferprice_dialog.appendChild(img);
						var tag=ui.create.div();
						tag.style.cssText='height:30px;width:30px;top:0%;left:0%;';
						window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+((this.grade=='godgrade'||this.grade=='half-godgrade')?'tiangrade':this.grade)+'.jpg',tag,true,"100% 100%");
						img.appendChild(tag);
					...
					window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/'+((info.grade=='godgrade'||info.grade=='half-godgrade')?'tiangrade':info.grade)+'.jpg',tag,true,"100% 100%");
		...
		window.ykCacheSetImage('https://jfc1999.coding.net/p/dpcqxyys/d/yunkong/git/raw/master/extension/auctionRecord.jpg',record,true,'100% 100%');
